...
function App() {
  ...
  return (
    ...
    <div className='lg:ml-[250px] px-4 '>
        <div className='p-2 flex justify-between items-center flex-wrap'>
        <div className='flex mt-5 justify-center flex-col items-center leading-3 h-full'>
           <h1 className='text-xl flex  font-semibold text-gray-700 pl-8 lg:pl-5 mb-4 lg:mb-0'>Overview</h1>
        ...
        <div className='flex flex-wrap pt-6 gap-4'>
          ...
          <div className='w-full md:w-1/2 lg:w-[32%] h-[450px] text-white bg-blue-500 p-4 shadow-sm rounded-lg space-y-4'>
          ...
          {/* Notes */}
          <div className='w-full  md:w-1/2 lg:w-[32%] p-3 h-[450px] bg-white shadow-sm rounded-lg'>
            ...
            <div key={caseItem._id} className='p-3 shadow-md rounded-md'>
          ...
          {/* Weather */}
          <div className='w-full md:w-1/2 lg:w-[32%] p-4 h-[450px] '>
          ...
          <div className='w-full md:w-1/2 lg:w-[32%] h-[450px] bg-white space-y-3 p-4 shadow-sm rounded-lg '>
          ...
          <LiaDownloadSolid className='text-gray-400 cursor-pointer' size={20} />
          </div>
          <hr/>
          <div className='flex justify-between items-center gap-3'>
          <div className='flex gap-3'>
          ...
          <div className='w-full md:w-1/2 lg:w-[32%] h-[450px] bg-white  p-4 shadow-sm rounded-lg space-y-4'>
